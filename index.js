...
while (continueOperation) {
    ...
    if (operationAnswer.operation === "Deposit") {
        ...
        console.log(chalk.green("Deposited " + depositedAmount.amount + " pkr succesfully"));
    ...
    if (operationAnswer.operation === "Withdraw") {
        ...
        if (withdrawnAmount > balance) {
            ...
            console.log(chalk.green("Withdrawn " + withdrawnAmount + " pkr successfully"));
    ...
    if (operationAnswer.operation === "Fast Cash") {
        ...
        console.log(chalk.green("Fast Cash of" + cashAmount.amount + " pkr withdrawn successfully"));
